//
// Created by paramath on 11/21/23.
//
...
int main() {
    ...
    for(int i=0; i < 1000; i++)
    {
        ...
        // V* W first
        cblas_dgemm(CblasRowMajor, CblasNoTrans, CblasNoTrans, m3, n4, n3, 1.0, V, n3, W, n4, 0.0, tmp1, n4);

        // B * (V * W)
        cblas_dgemm(CblasRowMajor, CblasNoTrans, CblasNoTrans, m2, n4, n2, 1.0, B, n2, tmp1, n4, 0.0, tmp2, n4);
